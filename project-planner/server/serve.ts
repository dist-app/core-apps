...
import { apiGroups, BundleConfig, entityKinds, BundleEntities } from 'https://uber.danopia.net/dist-app-deno/affe913e555847a6c93dc173808fbaf19ae9e90c/server-sdk/core/entities.ts';
import { AppServer } from "https://uber.danopia.net/dist-app-deno/affe913e555847a6c93dc173808fbaf19ae9e90c/server-sdk/core/app-server.ts";
import { DenoKvStorage } from "https://uber.danopia.net/dist-app-deno/affe913e555847a6c93dc173808fbaf19ae9e90c/server-sdk/modules/storage-deno-kv/mod.ts";
import { mountManagePage } from 'https://uber.danopia.net/dist-app-deno/affe913e555847a6c93dc173808fbaf19ae9e90c/server-sdk/modules/mount-manage-page.ts';
import { mountWebManifest } from 'https://uber.danopia.net/dist-app-deno/affe913e555847a6c93dc173808fbaf19ae9e90c/server-sdk/modules/mount-webmanifest.ts';
import { setupSingleSite } from "https://uber.danopia.net/dist-app-deno/affe913e555847a6c93dc173808fbaf19ae9e90c/server-sdk/core/single-site.ts";
// import { type MeteorAppBuildMeta } from '../bundle-config.ts';
import { type UserEntity } from "https://uber.danopia.net/dist-app-deno/affe913e555847a6c93dc173808fbaf19ae9e90c/apis/login-server/definitions.ts";
import { type ViteAppEntity } from "https://uber.danopia.net/dist-app-deno/affe913e555847a6c93dc173808fbaf19ae9e90c/apis/bundle/definitions.ts";
...
// import { CollectionEntityApiMapping, DistInterface, SignedOutDistInterface, userNameMap } from 'https://uber.danopia.net/dist-app-deno/affe913e555847a6c93dc173808fbaf19ae9e90c/hack/meteor-server/interface/registry.ts';
